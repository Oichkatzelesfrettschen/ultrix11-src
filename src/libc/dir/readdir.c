...
/**
 * @brief Retrieve the next directory entry.
 *
 * Converts old-style directory structures into the modern
 * @c struct direct format. Successive calls iterate over the
 * entries in @p dirp until no more entries are available.
 *
 * @param dirp Directory descriptor returned by ::opendir.
 * @return Pointer to the next entry or NULL at end of directory.
 */
